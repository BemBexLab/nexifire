...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "NexiFire does not operate like a traditional service provider. We assess and design the strategy and oversee execution, while our specialized brands handle each function with dedicated expertise.",
  },
  {
    question: "How does your ecosystem work?",
    answer:
      "We start by understanding your business and developing a clear growth strategy. From there, we assign the right specialized brands for each area, such as publishing, technology, or marketing, while maintaining centralized coordination and performance tracking.",
  },
  {
    question: "Why do you use multiple brands instead of one team?",
    answer:
      "Because specialization delivers better results. Each brand is built to master one specific area, which allows for higher quality execution compared to a generalist team trying to do everything, and not come up with high-quality results",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Execution is carried out through our specialized brands, including dedicated teams for book writing, editing, proofreading, marketing and publishing, audiobook production, website development, and digital marketing.",
  },
  {
    question: "Can I choose specific services or brands?",
    answer:
      "Yes. Depending on your needs, we can deploy one specialized brand or multiple brands as part of a complete growth system.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our approach combines strategy, specialized execution, and continuous optimization. Instead of isolated efforts, we build connected systems designed for long-term scalability and measurable results.",
  },
  {
    question: "How do I get started with NexiFire?",
    answer:
      "You can start by consulting with our team. We will assess your current position, identify growth opportunities, and recommend a structured approach using the right combination of our specialized brands.",
  },
];
